...
Socket = (...args) => {
   ...
   client.sendMessageModify = async (jid, text, quoted, properties, options = {}) => {
      ...
      return client.generateMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               title: properties.title || 'VORZ BOT OFFICIAL',
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               mediaUrl: `https://jsonformatter.org`,
               body: '',
               description: 'VORZ BOT',
               showAdAttribution: false,
               thumbnail: pic,
               sourceUrl: 'https://azrehums.gerogafrngkut.repl.co'
            }
         }
      }, {
         quoted
   ...
   client.sendTemplateButton = async (jid, source, text, footer, buttons = [], type) => {
      ...
      let options = (type && type.document) ? {
         ...
         fileName: (type && type.name) ? type.name : 'VORZ BOT',
   ...
   client.sendButton = async (jid, source, text, footer, quoted, buttons = [], type, opts) => {
      ...
      let options = (type && type.location) ? {
         ...
         headerType: 3,
         fileName: opts && opts.fileName ? opts.fileName : 'VORZ BOT',
         ...
         contextInfo: {
            externalAdReply: {
               mediaType: 1,
               title: opts && opts.title ? opts.title : '© VORZ BOT',
   ...
   client.sendButton2 = async (jid, source, text, footer, quoted, buttons = [], type, opts) => {
      ...
      let options = (type && type.location) ? {
         ...
         contextInfo: {
            externalAdReply: {
         mediaUrl: 'https://azrehums.gerogafrngkut.repl.co',
         mediaType: 2,
         renderLargerThumbnail: true,
         showAdAttribution: true,
         title: opts && opts.title ? opts.title : '© VORZ BOT',
